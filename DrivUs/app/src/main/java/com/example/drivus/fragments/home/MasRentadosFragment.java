...
public class MasRentadosFragment extends Fragment implements Response.ErrorListener, Response.Listener<JSONObject>{

    RecyclerView recyclerViewAutosMasRentados;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerViewAutosMasRentados = view.findViewById(R.id.recycler_autos_rentados);
        recyclerViewAutosMasRentados.setLayoutManager(new LinearLayoutManager(this.getContext()));
        recyclerViewAutosMasRentados.setHasFixedSize(true);

        requestQueue = Volley.newRequestQueue(getContext());

        cargarCarros_MasRentados();

        return view;
    }
    private void cargarCarros_MasRentados(){
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            e.printStackTrace();
            Toast.makeText(MasRentadosFragment.super.getContext(), "No se ha podido establecer conexion con el servidor" + " " + response, Toast.LENGTH_LONG).show();
            progress.hide();
        }
    }
}