        ...
        try {
            ...
            adapter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v){
                    String id_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getId();
                    String nombre_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getNombre();
                    String marca_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getMarca();
                    String precio_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getPrecio();
                    String url_imagen_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getRutaImagen();
                    String year_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getAnioo();
                    String cambios_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getCambios();
                    String combustible_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getCombustible();
                    String aire_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getAire();
                    String puertas_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getPuertas();
                    String velocidad_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getKilometraje();
                    String motor_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getMotor();
                    String asientos_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getAsientos();
                    String bolsa_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getBolsa();
                    String color_Auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getColor();
                    String descripcion_auto = elementos_carros.get(recyclerViewTodosAutos.getChildAdapterPosition(v)).getDescripcion();
